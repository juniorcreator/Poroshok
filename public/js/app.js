...
/* harmony import */ var _js_vendors_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../js/vendors/scroll */ "./resources/js/vendors/scroll.js");
/* harmony import */ var _js_vendors_scroll__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_js_vendors_scroll__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _js_vendors_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/vendors/map */ "./resources/js/vendors/map.js");
/* harmony import */ var _js_vendors_map__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_vendors_map__WEBPACK_IMPORTED_MODULE_3__);
...
function () {
  ...
  _createClass(App, [{
    key: "macy_params",
    value: function macy_params(selector, column, trueOrder, waitForImages, m_x, m_y, br_1200, br_940, br_520, br_400) {
      return {
        container: selector,
        columns: column,
        trueOrder: trueOrder,
    ...
    value: function cut_eny_text(selector, condition, neededlength) {
      var text = document.querySelectorAll(".".concat(selector));
      text.forEach(function (text) {
        var getText = text.textContent;
        text.textContent = getText.length > condition ? text.textContent.slice(0, neededlength) + '...' : text.textContent;
      });
    }
  }, {
    key: "load_more_items",
    value: function load_more_items(selector, condition) {
      var that = this;

      var counter = function counter() {
        var visible_items = $("".concat(selector, ":visible"));
        var all_products = $(selector);
      ...
      $(".js-load-more").on('click', function (e) {
        ...
        e.preventDefault();
        setTimeout(function () {
          if ($("".concat(selector, ":hidden")).length == 0) {
            $(_this).remove();
            return;
          }
        }, 400);
        $("".concat(selector, ":hidden")).slice(0, condition).css('display', 'block');
        that.macy_gallery();
        counter();
        $('html,body').animate({
    ...
    key: "show_all_items",
    value: function show_all_items(selectItem) {
      $(selectItem).css('display', 'block');
    }
  }, {
    key: "load_home_gallery_items",
    value: function load_home_gallery_items() {
      this.load_more_items('.gallery-item', 5);
    }
  }, {
    key: "show_all_popular_home",
    value: function show_all_popular_home(selector, button) {
      var _this2 = this;

      var items = $('.most-popular__wrap .pool-item');
      var btn = $('.js-btn--show-all');
      items.slice(0, 3).css('display', 'block');
      btn.on('click', function () {
        _this2.show_all_items(items);
    ...
    key: "show_all_hit_sale",
    value: function show_all_hit_sale(selector, button) {
      var _this3 = this;

      var items = $('.hit-sale .product');
      var btn = $('.js-hit-sale');
      items.slice(0, 5).css('display', 'block');
      btn.on('click', function () {
        _this3.show_all_items(items);
    ...
    key: "show_all_sales",
    value: function show_all_sales(selector, button) {
      var _this4 = this;

      var items = $('.all-sales .product');
      var btn = $('.js-all-sales');
      items.slice(0, 5).css('display', 'block');
      btn.on('click', function () {
        _this4.show_all_items(items);
    ...
    key: "slider_powder_color",
    value: function slider_powder_color() {
      var img_slider = $('.s-powder-color .slider-white-fon');
      img_slider.slick({
    ...
    key: "slider_powder_gradient",
    value: function slider_powder_gradient() {
      var slider_powder_gradient = $('.slider-gradient');
...
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var map; // Функция initMap которая отрисует карту на странице
...
/***/ "./resources/js/vendors/scroll.js":
/*!****************************************!*\
  !*** ./resources/js/vendors/scroll.js ***!
  \****************************************/
/*! no static exports found */
...
__webpack_require__(/*! C:\Projects\work\P_Okraska\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Projects\work\P_Okraska\resources\sass\app.scss */"./resources/sass/app.scss");
